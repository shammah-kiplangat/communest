    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative min-h-screen flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 py-24">
          ...
          <p className="text-lg sm:text-xl text-slate-300 max-w-2xl mx-auto mb-10 leading-relaxed">
            Communest connects Kenyans with quality housing and empowers estate
            managers with powerful tools to run their properties effortlessly.
          </p>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        <div className="text-center mb-16">
          ...
          <p className="text-[var(--muted-foreground)] max-w-xl mx-auto">
            Whether you're searching for a home or managing an estate, Communest
            has the tools to make it simple.
          </p>
        </div>
            ...
            {[
              {
                ...
                desc: "Sign up in minutes with your name, email, and phone. Verify your details to build trust on the platform.",
              },
              {
                step: "02",
                title: "Explore & Discover",
                desc: "Browse estates by county and price range. View house photos, amenities, and rental prices all in one place.",
              },
              {
                step: "03",
                title: "Apply & Move In",
                desc: "Found your home? Submit a rental application. Once approved by the estate admin, you're a verified Communest Tenant!",
              },
            ].map(({ step, title, desc }) => (
              <div
                key={step}
                className="glass-card rounded-2xl p-7 text-center hover:-translate-y-1 transition-all duration-300"
              >
                <div className="text-5xl font-black text-[var(--accent)]/30 mb-4 select-none">
                  {step}
                </div>
                <h3 className="font-semibold text-white mb-2">{title}</h3>
                <p className="text-sm text-[var(--muted-foreground)] leading-relaxed">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        ...
        <div className="grid sm:grid-cols-3 gap-5">
          {TESTIMONIALS.map(({ name, role, text, rating }) => (
            <div
              key={name}
              className="glass-card rounded-2xl p-6 hover:border-blue-500/25 transition-all"
            >
      ...
      <section className="py-20 px-4 sm:px-6">
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(29,78,216,0.3) 0%, rgba(37,99,235,0.15) 100%)",
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle at 30% 50%, #2563eb 0%, transparent 60%)",
            }}
          />
          <div className="relative z-10">
            ...
            <p className="text-[var(--muted-foreground)] mb-8 max-w-lg mx-auto">
              Join thousands of Kenyans who have found quality housing through
              Communest. Your perfect home is just a few clicks away.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/auth"
